...
export function ThemeToggle({ disabled = false }: { disabled?: boolean }) {
  ...
  return (
    <div className={`gx-theme-toggle${disabled ? ' disabled' : ''}`} title={disabled ? 'Theme switching disabled' : undefined}>
      <button
        ...
        disabled={disabled}
      >
        <svg className="gx-theme-btn-icon" fill="currentColor" viewBox="0 0 20 20">
